...
const style = {
  wrapper: `rounded-lg border px-1 py-2 focus:shadow-md dark:border-transparent dark:bg-[#333333] flex items-center space-x-3 pl-3`,
...
const SearchInput = () => {
  return (
    <div className={style.wrapper}>
      ...
      <input className={style.input} type="text" placeholder="Search items, collections, and accounts" />
    </div>
  )
}
