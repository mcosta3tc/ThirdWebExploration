...
import { SearchIcon, MenuIcon, CreditCardIcon, MoonIcon, SunIcon } from '@heroicons/react/outline'
...
const Navbar = () => {
  ...
  const renderThemeChanger = () => {
    ...
    if (currentTheme === 'dark') {
      return <MoonIcon className={style.themeSwitcher} role="button" onClick={() => setTheme('light')} />
    } else {
      return <SunIcon className={style.themeSwitcher} role="button" onClick={() => setTheme('dark')} />
    }
  }
